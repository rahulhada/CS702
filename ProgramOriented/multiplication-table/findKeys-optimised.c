 ...
 * in an efficient way (using property of multiplicative inverse that 
 * if a is the multiplicative inverse of b on Z, then b is the multiplicative
 * inverse of a for that Z)
 */
